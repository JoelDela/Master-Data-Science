...
x2<-as.POSIXct(NULL)
y2<-as.data.frame(NULL)[,"Point Forecast"]
...
forecastplot<-plot_ly(x = NULL, y = NULL, mode = 'lines',type = 'scatter',name="Hist\u00f3rico") %>%
  add_trace(x=NULL, y = NULL, name = "Previsi\u00f3n") %>%
